...
<div id="vg-node-farmer" class="vg-node absolute -translate-x-1/2 -translate-y-1/2 z-30 cursor-pointer flex flex-col items-center select-none transition-all duration-700">
  ...
  <span class="node-title absolute -bottom-9 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full text-sm font-bold text-[#111827] bg-white border border-[#E5E7EB] shadow-sm whitespace-nowrap">Productor</span>
</div>
...
<div id="vg-node-pilot" class="vg-node absolute -translate-x-1/2 -translate-y-1/2 z-30 cursor-pointer flex flex-col items-center select-none transition-all duration-700">
  ...
  <span class="node-title absolute -bottom-9 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full text-sm font-bold text-[#111827] bg-white border border-[#E5E7EB] shadow-sm whitespace-nowrap">Pilotos</span>
</div>
...
<div id="vg-node-dev" class="vg-node absolute -translate-x-1/2 -translate-y-1/2 z-30 cursor-pointer flex flex-col items-center select-none transition-all duration-700">
  ...
  <span class="node-title absolute -bottom-9 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full text-sm font-bold text-[#111827] bg-white border border-[#E5E7EB] shadow-sm whitespace-nowrap">Desarrolladores</span>
</div>
  ...
  `;
    ...
    function runEcosystemAnimation() {
      ...
      // PASO 5: Revelar Isotipo Vistaguay y líneas centradas
      setTimeout(() => {
