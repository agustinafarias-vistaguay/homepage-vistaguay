...
function renderSolutionsCard(tabKey, subKey = currentWeedSubKey) {
    ...
    if (tabKey === 'special') {
        leftColumnHtml = `
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 border-t border-outline-variant/30 pt-6">
                <div>
                    <h4 class="text-xs sm:text-[13px] font-bold text-primary mb-1.5">Ganadería</h4>
                    <p class="text-[11px] sm:text-xs text-slate-600 leading-relaxed">Conteo y estimación de peso.</p>
                </div>
                <div>
                    <h4 class="text-xs sm:text-[13px] font-bold text-primary mb-1.5">Cultivos especiales</h4>
                    <p class="text-[11px] sm:text-xs text-slate-600 leading-relaxed">Cítricos, Yerba Mate, Caña de Azúcar, Viñedos y Pasturas.</p>
                </div>
                <div>
                    <h4 class="text-xs sm:text-[13px] font-bold text-primary mb-1.5">Forestal & reforestación</h4>
                    <p class="text-[11px] sm:text-xs text-slate-600 leading-relaxed">Mapeo de densidad y siembra aérea.</p>
                </div>
                <div>
                    <h4 class="text-xs sm:text-[13px] font-bold text-primary mb-1.5">Altimetría & topografía</h4>
                    <p class="text-[11px] sm:text-xs text-slate-600 leading-relaxed">Modelos digitales de elevación y escurrimiento de agua.</p>
                </div>
            </div>
            <div class="pt-4">
        ...
        const bulletsHtml = data.bullets.map(b => {
            ...
            if (isSpecial) {
                return `
                    <li class="text-xs sm:text-sm font-bold text-slate-700 leading-normal flex items-center gap-2 my-1">
    ...
    <span class="material-symbols-outlined text-sm font-bold">arrow_forward</span>
            ...
            return `
                <li class="text-xs sm:text-sm font-medium text-slate-700 leading-normal flex items-center gap-2">
                    <span class="material-symbols-outlined text-primary text-xs shrink-0 w-4 h-4 flex items-center justify-center">check_circle</span>
                    <span>${b}</span>
                </li>
            `;
